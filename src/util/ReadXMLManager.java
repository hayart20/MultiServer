...
/**
 * Working with Xml.
 * for example parse given XML file.
 * 
 * @author hayk
 *
 */
public class ReadXMLManager {
	 ...
	 * as result return Bean file which is contain information from xml.
	 * @return
	 */
	public XmlFileDataBean parseServerXmlFile() {
	...
	/**
	 * parse element by given tagname and give int value.
	 * @param eElement
	 * @param tagName
	 * @return
	 */
